...
## Saber que persona esta iniciada sesion y  cambio de paleta de colores.

  1. Barra de "Sesión de: nombre" en header.
  2. Cambio de paleta de colores referencias sacada de los logo del instituto y internet.

Fecha --> 11/05/2026 - 16/05/2026

## Contador de Alumnos que estan en el aseo y titulo.

  1. Contador de Alumnos que estan fuera.
  2. Cambiar titulo de la web a "Control de Salidas".

Fecha --> 18/05/2026 - 22/05/2026

## Conexión con Hellin-App

  Implementar cambios realizados por Juan Antonio y Juan Carlos a nuestro proyecto, para usar su login.
